...
/**
 * Things categories grid container
 *
 * @category   Oggetto
 * @package    Oggetto_Things
 * @subpackage Block
 ...
 */
class Oggetto_Things_Block_Adminhtml_Category
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = $this->helper('things')->__('Categories');
        $this->_addButtonLabel = $this->helper('things')->__('Add Category');
        parent::__construct();
    }
}
