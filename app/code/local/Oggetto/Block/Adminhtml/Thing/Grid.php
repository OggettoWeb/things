 ...
 */
class Oggetto_Things_Block_Adminhtml_Thing_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('things/thing')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('description', array(
            'header' => $this->helper('things')->__('Description'),
            'index'  => 'description',
            'type'   => 'text',
        ));
